/* ============================================================
   ...
   US QWERTY, shift, caps-lock, ctrl, alt,
   arrow keys, F1-F12, ring buffer.
   ============================================================ */
#include "keyboard.h"
    ...
    if (s_extended) {
        ...
        if (!released) {
            switch (sc) {
                ...
                case 0x52: buf_push(KB_KEY_INSERT);  return;
